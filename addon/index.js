  ...
  return EmberObject.extend(
    Evented,
    {
      ...
      errors: objectToArray(
        ERRORS,
        (e /*: Err */) => ({ value: e.value, validation: e.validation }),
        true
      ),
      change: inflate(CHANGES, c => c.value),
      error: inflate(ERRORS, e => ({
        value: e.value,
    ...
    */
       ...
       */
      unknownProperty(key /*: string */) /*: RelayDef | mixed */ {
       ...
       */
      toString() /*: string */ {
        let normalisedContent /*: Object */ = pureAssign(
          get(this, CONTENT),
          {}
        );
      ...
      prepare(
        ...
        assert(
          "Callback to `changeset.prepare` must return an object",
          isObject(preparedChanges)
        );
       ...
       */
      save(options /*: Object */) /*: Promise<ChangesetDef | mixed> */ {
        let content /*: Object */ = get(this, CONTENT);
        let savePromise /*: mixed | Promise<ChangesetDef | mixed> */ = resolve(
          this
        );
      ...
      merge(changeset /*: ChangesetDef */) /*: ChangesetDef */ {
        ...
        let newChangeset /*: ChangesetDef */ = new Changeset(
          content,
          get(this, VALIDATOR)
        );
      ...
      cast(allowed /*: Array<string> */ = []) /*: ChangesetDef */ {
        ...
        let validKeys = emberArray(changeKeys).filter((key /*: string */) =>
          includes(allowed, key)
        );
      ...
      isValidating(key /*: string | void */) /*: boolean */ {
        let runningValidations /*: RunningValidations */ = get(
          this,
          RUNNING_VALIDATIONS
        );
      ...
      _validateAndSet /*:: <T> */(
        ...
        let validation /*: ValidationResult | Promise<ValidationResult> */ = c._validate(
          key,
          value,
          oldValue
        );
      ...
      _setProperty /*:: <T> */(
        ...
        assert(
          "Value must not be a Relay. If you see this error, please open an issue on https://github.com/poteto/ember-changeset/issues.",
          !isRelay(value)
        );
       ...
       */
      _relayFor(key /*: string */, value /*: Object */) /*: RelayDef */ {
      ...
      _notifyVirtualProperties(
        ...
        (keys || []).forEach(key =>
          this /*: ChangesetDef */.notifyPropertyChange(key)
        );
      },
       ...
       */
      _deleteKey(objName /*: string */, key /*: string */ = "") /*: void */ {
